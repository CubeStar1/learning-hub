...
import { SelectMaterial } from '@/app/components/podcast/SelectMaterial'
          ...
          <div className="space-y-4 min-w-0">
            <Tabs defaultValue="upload" className="w-full">
              <TabsList className="w-full">
                ...
                <TabsTrigger value="select" className="flex-1">Select Material</TabsTrigger>
              </TabsList>
